...
def _(
    ...
    if USE_MEASURED_STRETCH:
        stretch_series = np.clip(
            _sl_rel * MEASURED_STRETCH_GAIN / STRETCH_AMOUNT, -2.4, 2.4)
        print(f"torso length driver REPLACED by measured stretch: seg_scale "
              f"range {1 + stretch_series.min() * STRETCH_AMOUNT:.3f}"
